...
import com.lq.springdemo.utils.RSA2Utils;
...
public class RASTest {
    ...
    public void Test()  throws Exception {
        ...
        // 公私钥对
        Map<String, byte[]> keyMap = RSA2Utils.generateKeyBytes();
        String publicKey = Base64.encode( keyMap.get(RSA2Utils.PUBLIC_KEY));

        System.out.println("验签公钥==>"+publicKey);

        String privateKey =Base64.encode(keyMap.get(RSA2Utils.PRIVATE_KEY));
...
//
        ...
        try {
            ...
            String enpublicKey=Base64.encode( keyMap.get(RSA2Utils.PUBLIC_KEY));

            System.out.println("加密公钥="+enpublicKey);

            String deprivateKey=Base64.encode(keyMap.get(RSA2Utils.PRIVATE_KEY));
    ...
    @Test
    public void JM(){
        String publickey = "";
        String Content ="{\"content\":\"{\\\"orderProducts\\\":[{\\\"productSku\\\":\\\"\\\",\\\"productBarcode\\\":\\\"\\\",\\\"productTitle\\\":\\\"LED Stage Lighting \\\\/ LED PAR Light \\\\/ Stage Truss Light (Parco 9D) \\\\/d\\\",\\\"opQuantity\\\":3,\\\"opValue\\\":200,\\\"opValueTotal\\\":600}],\\\"plateCode\\\":\\\"lightrade\\\",\\\"referenceNo\\\":\\\"9928818286207\\\",\\\"sellerCode\\\":\\\"SE0226\\\",\\\"orderAmount\\\":700,\\\"salesAmount\\\":600,\\\"goodsValue\\\":600,\\\"orderCurrency\\\":\\\"USD\\\",\\\"smCode\\\":\\\"HKDHL\\\",\\\"returnUrl\\\":\\\"http:\\\\/\\\\/www.zhaoming123.com\\\\/Views\\\\/Order\\\\/PayResult.aspx\\\",\\\"notifyUrl\\\":\\\"http:\\\\/\\\\/www.zhaoming123.com\\\\/Views\\\\/Order\\\\/referenceN.aspx\\\",\\\"orderType\\\":\\\"1\\\",\\\"payType\\\":\\\"2\\\",\\\"plateformFee\\\":0,\\\"logisticsFee\\\":100,\\\"globexFee\\\":0,\\\"eTradePayFee\\\":0,\\\"smType\\\":\\\"HY\\\",\\\"note\\\":\\\"\\\",\\\"deleteOld\\\":1,\\\"deposit\\\":500,\\\"finalPayment\\\":200}\",\"timestamp\":1554898083,\"version\":\"1.0.0\"}";
        String mw = encrypt(Content,publickey);
    }
    ...
    public static String encryptByPrivateKey(String content, String privateKey)
            throws Exception {
        Key privateK = RSA2Utils.restorePrivateKey(Base64.decode(privateKey));
        Cipher cipher = Cipher.getInstance(RSA2Utils.KEY_ALGORITHM);
    ...
    public String signStr(String privateKey, String plainText) {
        return bytesToHexString(sign(RSA2Utils.restorePrivateKey(Base64.decode(privateKey)), plainText));
    }
    ...
    public boolean verifySignStr(String publicKey, String plainText, String signValue) {
        return verifySign(RSA2Utils.restorePublicKey(Base64.decode(publicKey)), plainText, hexStringToBytes(signValue));
    }
